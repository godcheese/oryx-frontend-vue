<template>
    <div>
        ...
        <a-modal title="新增数据字典分类" v-model="visible" :maskClosable="false" wrapClassName="form-modal"
                 :destroyOnClose="true">
...
<script>
    import {
        ...
        dictionaryCategoryGetOneByDictionaryCategoryId,
        dictionaryCategoryListAllAsAntdTreeNode
    } from '../../../api/dictionaryCategory.js'
        ...
        methods: {
            ...
            onOk() {
                this.form.validateFieldsAndScroll((error, values) => {
                    if (!error) {
                        dictionaryCategoryAddOne(values).then((data) => {
