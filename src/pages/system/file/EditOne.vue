                ...
                <a-row>
                    ...
                    <a-col :md="12" :sm="24">
                        <a-form-item label="文件大小" :labelCol="{span: 8}" :wrapperCol="{span: 16, offset: 0}">
                            <a-input v-decorator="['prettySize',{rules: [{required: true, message: '必填',}],}]"
                                     :disabled="true"/>
                        </a-form-item>
                    </a-col>
                    <a-col :md="12" :sm="24">
                        <a-form-item label="MIME 类型" :labelCol="{span: 9}" :wrapperCol="{span: 15, offset: 0}">
                            <a-input v-decorator="['mimeType',{rules: [{required: true, message: '必填',}],}]"
                                     :disabled="true"/>
                        </a-form-item>
                    </a-col>
                    <a-col :md="12" :sm="24">
                        <a-form-item label="唯一标识符" :labelCol="{span: 10}" :wrapperCol="{span: 14, offset: 0}">
                            <a-input v-decorator="['guid',{rules: [{required: true, message: '必填',}],}]"
                                     :disabled="true"/>
                        </a-form-item>
                    </a-col>
                    <a-col :md="24" :sm="24">
                        <a-form-item label="文件路径" :labelCol="{span: 6}" :wrapperCol="{span: 18, offset: 0}">
                            <a-textarea v-decorator="['path',{rules: [{required: true, message: '必填',}],}]"
                                        :autosize="{ minRows: 2, maxRows: 10 }" :disabled="true"/>
                        </a-form-item>
                    </a-col>
                    <a-col :md="24" :sm="24">
