<template>
    <div>
        ...
        <a-modal title="编辑 API 分类" v-model="visible" :maskClosable="false" wrapClassName="form-modal"
                 :destroyOnClose="true">
...
<script>
    ...
    import {
        ...
        apiCategoryListAllAsAntdTreeNode,
        apiCategorySaveOne
        ...
        methods: {
            ...
            onOk() {
                this.form.validateFieldsAndScroll((error, values) => {
                    if (!error) {
                        apiCategorySaveOne(values).then((data) => {
