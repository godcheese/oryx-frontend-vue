<template>
    <div>
        ...
        <a-modal title="API 管理" v-model="visible" :maskClosable="false" wrapClassName="form-modal"
            ...
            <a-row>
                ...
                <a-col :span="12">
                    <div class="table-operations">
                        <ApiGrantAll v-has-any-authority="['/COMPONENT/USER/ROLE/API/API_GRANT_ALL']"
                                     :tableSelectedRowKeys="apiTableSelectedRowKeys" :roleId="tableSelectedRowKeys[0]"
                                     @onOk="() => {this.reloadApiTable()}"/>
                        <ApiRevokeAll v-has-any-authority="['/COMPONENT/USER/ROLE/API/API_REVOKE_ALL']"
                                      :tableSelectedRowKeys="apiTableSelectedRowKeys" :roleId="tableSelectedRowKeys[0]"
                                      @onOk="() => {this.reloadApiTable()}"/>
                    </div>
                    <div style="overflow: scroll;height: 300px">
