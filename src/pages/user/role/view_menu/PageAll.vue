<template>
    <div>
        ...
        <a-modal title="视图菜单管理" v-model="visible" :maskClosable="false" wrapClassName="form-modal"
                 :destroyOnClose="true" :width="1200" style="height: 300px">
            <a-row>
                <a-col :span="12">
                    <div class="table-operations">
                        <ViewMenuCategoryGrantAll
                                v-has-any-authority="['/COMPONENT/USER/ROLE/VIEW_MENU/VIEW_MENU_CATEGORY_GRANT_ALL']"
                                :tableSelectedRowKeys="viewMenuCategoryTableSelectedRowKeys"
                                :roleId="tableSelectedRowKeys[0]" @onOk="reloadTable"/>
                        <ViewMenuCategoryRevokeAll
                                v-has-any-authority="['/COMPONENT/USER/ROLE/VIEW_MENU/VIEW_MENU_CATEGORY_REVOKE_ALL']"
                                :tableSelectedRowKeys="viewMenuCategoryTableSelectedRowKeys"
                                :roleId="tableSelectedRowKeys[0]" @onOk="reloadTable"/>
                    </div>
                ...
                <a-col :span="12">
                    <div class="table-operations">
                        <ViewMenuGrantAll v-has-any-authority="['/COMPONENT/USER/ROLE/VIEW_MENU/VIEW_MENU_GRANT_ALL']"
                                          :tableSelectedRowKeys="viewMenuTableSelectedRowKeys"
                                          :roleId="tableSelectedRowKeys[0]" @onOk="() => {this.reloadViewMenuTable()}"/>
                        <ViewMenuRevokeAll v-has-any-authority="['/COMPONENT/USER/ROLE/VIEW_MENU/VIEW_MENU_REVOKE_ALL']"
                                           :tableSelectedRowKeys="viewMenuTableSelectedRowKeys"
