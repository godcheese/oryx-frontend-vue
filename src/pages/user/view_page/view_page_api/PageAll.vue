      ...
      <a-row>
        ...
        <a-col :span="12">
          <div class="table-operations">
            <AssociateAll :tableSelectedRowKeys="apiTableSelectedRowKeys" :pageId="tableSelectedRowKeys[0]" @onOk="() => {this.reloadApiTable()}"/>
            <RevokeAssociateAll :tableSelectedRowKeys="apiTableSelectedRowKeys" :pageId="tableSelectedRowKeys[0]" @onOk="() => {this.reloadApiTable()}"/>
          </div>
          <div style="overflow: scroll;height: 300px">
...
<script>
  ...
  import {apiPageAllAsAntdTableByPageIdAndApiCategoryIdList} from '../../../../api/api.js';
  ...
  export default {
    ...
    methods: {
      api() {
        ...
        this.visible = true
        this.pageId = tableSelectedRowKeys[0]
      ...
      getApiCategoryTableDataSource(params = {}) {
        ...
        if(tableSelectedRowKeys && tableSelectedRowKeys.length > 0 && this.visible) {
          ...
          apiCategoryListAllAsAntdTable({pageId: tableSelectedRowKeys[0],...params}).then((data) => {
      ...
      getApiTableDataSource(params = {}) {
        ...
        if (apiCategoryTableSelectedRowKeys && apiCategoryTableSelectedRowKeys.length > 0 && tableSelectedRowKeys && tableSelectedRowKeys.length === 1) {
          ...
          apiPageAllAsAntdTableByPageIdAndApiCategoryIdList({
            page: page, rows: rows, ...params,
            pageId: tableSelectedRowKeys[0],
