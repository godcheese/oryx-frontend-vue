        ...
        methods: {
            revokeAssociateAll() {
                ...
                this.$confirm({
                    ...
                    cancelText: '取消',
                    onOk: () => {
                        viewPageComponentApiRevokeAssociateAllByPageComponentIdAndApiIdList(this.tableSelectedRows[0].id, this.tableSelectedRows[0].viewPageComponentId).then((data) => {
