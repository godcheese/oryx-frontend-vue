<template>
    <div>
        ...
        <a-modal title="编辑视图页面分类" v-model="visible" :maskClosable="false" wrapClassName="form-modal"
                 :destroyOnClose="true">
        ...
        methods: {
            ...
            onOk() {
                this.form.validateFieldsAndScroll((error, values) => {
                    if (!error) {
                        viewPageCategorySaveOne(values).then((data) => {
            ...
            viewPageCategoryGetOneByViewPageCategoryId(id) {
                viewPageCategoryGetOneByViewPageCategoryId(id).then((data) => {
